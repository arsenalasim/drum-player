...
},{"./url":"node_modules/socket.io-client/lib/url.js","socket.io-parser":"node_modules/socket.io-parser/index.js","./manager":"node_modules/socket.io-client/lib/manager.js","debug":"node_modules/socket.io-client/node_modules/debug/src/browser.js","./socket":"node_modules/socket.io-client/lib/socket.js"}],"socket.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(Socket, [{
    ...
    key: "listenMessage",
    value: function listenMessage() {
      this.socket.on('receive:sound', function (data) {
        (0, _index.playSound)(data.sound);
      });
    }
  }]);
...
},{"socket.io-client":"node_modules/socket.io-client/lib/index.js","./index":"index.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
_socket.default.listenMessage();

var playButton = document.getElementsByClassName('playButton');
var sounds = ['boom', 'clap', 'hihat', 'kick', 'openhat', 'ride', 'snare', 'tink', 'tom'];
...
_toConsumableArray(playButton).forEach(function (button) {
...
function playSound(sound, target) {
  ...
  audio.play();
  setTimeout(function () {
    return target.classList.remove('playing');
  }, 300);
}
...
},{"./socket":"socket.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/drum.e31bb0bc.map